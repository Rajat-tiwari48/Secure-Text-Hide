...
def show():
    ...
    if password == '1234':
        ...
        code.set('')
#Logo
logo = ImageTk.PhotoImage(file='1234.jpg')
Label(win,image=logo,border=0).place(x=0,y=0)
#Heading
Label(win,text='Secure Text Hide',font='impack 30 bold',bg='black',fg='red').place(x=200,y=12)
#Frame 1
f1 = Frame(win,width=250,height=220,bd=5,bg='light green')
f1.place(x=50,y=100)
